<!-- Modal -->
<div wire:ignore.self class="modal fade" id="createVoteModal" tabindex="-1" aria-labelledby="createVoteModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="createVoteModalLabel" style="color: black; text-align:center">Create Vote
                </h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form wire:submit.prevent="createVote" action="">
