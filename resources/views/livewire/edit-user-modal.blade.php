    ...
    <div class="modal-content">
        ...
        <form wire:submit.prevent="editUser" action="">
            <div class="modal-body" style="color: black">
                ...
                <div class="row mt-4">
                    <div class="">
                    <select required wire:model="department" class="form-select @error('department')is-invalid @enderror" id="exampleFormControlSelect1" aria-label="Default select example">
                ...
                <div class="row mt-4">
                    <div class="">
                    <select required wire:model="role_id" class="form-select @error('role_id')is-invalid @enderror" id="exampleFormControlSelect1" aria-label="Default select example">
