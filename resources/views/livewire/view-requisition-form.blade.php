    ...
    <div class="card">
        <div class="card-body" x-data="{ isEditing: $wire.entangle('isEditing') }">
            ...
            @if (
                ...
                <div x-data="{ isCabEditing: $wire.entangle('isCabEditing') }">

                    <div class="fs-4 text-center divider-text fw-bold"><i
                            class="fa-solid fa-money-check-dollar me-2"></i>Cost
                        &
                        Budgeting</div>
                    <div class="text-end">
                        <button type="button" @click="isCabEditing = !isCabEditing"
                            x-bind:class="isCabEditing ? 'btn-danger' : 'btn-success'" class="btn btn-sm">
                            <i x-bind:class="isCabEditing ? 'fa-solid fa-xmark' : 'fa-solid fa-pen-to-square'"
                                class="me-1_5"></i>
                            <span x-text="isCabEditing ? 'Cancel' : 'Edit'"></span>
                        </button>
                    </div>
                    <div class="row mt-6">
                        <div class="col-md-6">
                            <div class="form-check mt-4">
                                <label class="form-check-label" for="defaultCheck1"> Availability of Funds
                                </label>
                                <input class="form-check-input" type="checkbox" value="" id="defaultCheck1"
                                    wire:model="availability_of_funds" x-bind:disabled="!isCabEditing">
                            </div>
                            <div class="form-check mt-4">
                                <label class="form-check-label" for="defaultCheck2"> Verified by Accounts </label>
                                <input class="form-check-input" type="checkbox" value="" id="defaultCheck2"
                                    wire:model="verified_by_accounts" x-bind:disabled="!isCabEditing">
                            </div>
                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col mt-3">
                                    <select style="width: 100%;" id="voteSelect" class="js-example-basic-multiple"
                                        multiple="multiple" x-bind:disabled="!isCabEditing">
                    ...
                    <div class="row mt-8" x-show="isCabEditing">
                        <div class="col text-center m-auto">
                            <button type="button" wire:click="saveCAB" wire:loading.attr="disabled"
                    ...
                    <div class="row mt-8" x-show="!isCabEditing">
                        <div class="col d-flex justify-content-center">
                            <button type="button" wire:click="approvedByCAB" wire:loading.attr="disabled"
                                ...
                                class="btn btn-success waves-effect waves-light d-flex align-items-center justify-content-center gap-2">
                        ...
                        <div class="col text-end d-flex justify-content-end gap-2">
                            ...
                            @elseif($requisitionForm->status === \App\RequestFormStatus::SENT_TO_HOD)
                                @if (Auth::user()->id == $requisitionForm->head_of_department_id)
                                    ...
                                    <button data-bs-toggle="modal" data-bs-target="#declineRequisitionForm"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-8">
                                    <input autocomplete="off" wire:model="estimated_value" type="number"
                                        step="0.01" x-bind:disabled="!isEditing"
                    ...
                    @if ($requisitionForm->requisition)
                        <div class="divider mt-6">
                            <div class="divider-text fw-bold fs-5"><i
                                    class="fa-solid fa-dollar-sign me-2"></i>Procurement
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col" style="text-align: center;padding-bottom:10px">
                            ...
                            <button @disabled(!$this->uploads) wire:click.prevent="uploadFiles()"
                                ...
                                wire:target="uploads,uploadFiles" style="width: 8rem"><i
